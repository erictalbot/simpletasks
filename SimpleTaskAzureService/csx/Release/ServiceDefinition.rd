...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="SimpleTaskAzureService" generation="1" functional="0" release="0" Id="c92691af-c19a-4603-ab0d-4e3311546fbd" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="SimpleTaskAzureServiceGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="SimpleTaskApp" generation="1" functional="0" release="0" software="C:\prog\DAC\SimpleTask\SimpleTaskAzureService\csx\Release\roles\SimpleTaskApp" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="6b7f127e-a00c-4831-bb78-3c4d96c58c2e" ref="Microsoft.RedDog.Contract\ServiceContract\SimpleTaskAzureServiceContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="a882b08c-1e9a-4106-919c-b26e4a56fbd6" ref="Microsoft.RedDog.Contract\Interface\SimpleTaskApp:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/SimpleTaskAzureService/SimpleTaskAzureServiceGroup/SimpleTaskApp:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="37a3b71e-890b-43c0-921a-96804f0be3a4" ref="Microsoft.RedDog.Contract\Interface\SimpleTaskApp:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/SimpleTaskAzureService/SimpleTaskAzureServiceGroup/SimpleTaskApp:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
